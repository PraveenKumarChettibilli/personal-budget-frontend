...
class DataService {
    ...
    getBudgetData(username) {
        ...
        this.DataObservable = this.http.get('http://138.197.16.76:3000/budget', { headers: headers, params: { userid: username } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])());
    ...
    userLogin(data) {
        ...
        const body = JSON.stringify(data);
        console.log(body);
        return this.http.post('http://138.197.16.76:3000/auth', body, { 'headers': headers }).subscribe((res) => {
            console.log(res);
...
FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FooterComponent, selectors: [["pb-footer"]], decls: 2, vars: 0, template: function FooterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " All rights reserved \u00A9 Praveen\n");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
